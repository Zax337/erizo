...
namespace erizo {
	...
	class DtlsTransport : dtls::DtlsReceiver, public Transport {
		public:
			DtlsTransport(MediaType med, const std::string &transport_name, bool bundle, bool rtcp_mux, const std::string& stunServ, const int stunPort, TransportListener *transportListener);
			~DtlsTransport();
